$(function(){
    ...
    // function myFunction(){
    //     var x;
    //     if (confirm("ill insert a downloadable pdf version of my resume here later") == true){
    //         x = "come back later for pdf version, for now enjoy my online resume";
    //     } else {
    //         x = "come back later for pdf version, for now enjoy my online resume";
    //     }
    //     document.getElementById("resume_demo").innerHTML = x;
    // }
